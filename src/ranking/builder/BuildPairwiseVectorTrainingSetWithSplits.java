...
public class BuildPairwiseVectorTrainingSetWithSplits {
	...
	protected static final String TRAIN_EVAL = "TrainEval";
	...
	public static void main(String[] args) throws IOException {
		...
		/*createPairwiseVectorBySide(ONLY_FRONT, npmFeaturesFile, pairwiseRankFile,TRAIN_EVAL);
		createPairwiseVectorBySide(ONLY_BACK, npmFeaturesFile, pairwiseRankFile,TRAIN_EVAL);
		createPairwiseVectorBySide(FRONT, npmFeaturesFile, pairwiseRankFile,TRAIN_EVAL);
		createPairwiseVectorBySide(BACK, npmFeaturesFile, pairwiseRankFile,TRAIN_EVAL);
		createPairwiseVectorBySide(ALL, npmFeaturesFile, pairwiseRankFile,TRAIN_EVAL);*/
		
		createPairwiseVectorBySide(ONLY_FRONT, npmFeaturesFile, pairwiseRankFile,TEST);
		createPairwiseVectorBySide(ONLY_BACK, npmFeaturesFile, pairwiseRankFile,TEST);
		createPairwiseVectorBySide(FRONT, npmFeaturesFile, pairwiseRankFile,TEST);
		createPairwiseVectorBySide(BACK, npmFeaturesFile, pairwiseRankFile,TEST);
		createPairwiseVectorBySide(ALL, npmFeaturesFile, pairwiseRankFile,TEST);

	}

	private static void createPairwiseVectorBySide(String dest, String npmFeaturesFile, String pairwiseRankFile, String split) throws IOException {
		...
		try {
			...
			fw = new FileWriter("D:/GHDataset/datasets/splits/dataSetPropuestaCSV"+dest+split,false);
			
			fr = new FileReader(npmFeaturesFile);
			fr2 = new FileReader(pairwiseRankFile+dest+split+".txt");
